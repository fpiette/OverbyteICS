...
entire volume of files (250,000 or more). TIcsFileCopy will similarly also delete
multiple files.  It includes directory listing and reporting functions.

TIcsFtpMulti FTP uploads and downloads multiple files and directories, mirroring the directory
structures, optionally only transferring changed files and deleting old files,
including resumed transfers after failure.

TIcsHttpMulti downloads multiple HTTP
files, either as a URL list or by parsing HTML pages and locating URLs to download.
...
27 Nov 2018 - 4.7 - Fixed HTTP to HTTPS relocation failed unless HTTPS URL precessed
                    ...
                    Only support SSL
7 Mar 2019 - V8.60 - Adapted for ICS
