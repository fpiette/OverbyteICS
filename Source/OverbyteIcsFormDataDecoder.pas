...
Apr 25, 2016 V8.04 Angus Moved TextToHtmlText and RemoveHtmlSpecialChars here gtom
...
const
    FormDataDecoderVersion = 804;
    CopyRight : String      = ' FormDataDecoder (c) 2003-2016 F. Piette V8.04 ';
