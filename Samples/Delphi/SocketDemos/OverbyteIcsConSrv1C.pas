...
* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *}
unit OverbyteIcsConSrv1C;

interface

{$I OVERBYTEICSDEFS.INC}
uses
    Messages, Windows, SysUtils, Classes, WinSock,
{$IFDEF COMPILER12_UP}
    AnsiStrings,
{$ENDIF}
    OverbyteIcsWSocket;
...
type
    ...
    protected
        ...
        FCtrlWindow    : HWND;
        FCommand       : array [0..2047] of AnsiChar;
        FCmdLen        : Integer;
        FPeerName      : String;
        ...
        procedure TELNET_Interpreter(CommandVerb : AnsiString;
                                     CommandTail : AnsiString);
    public
