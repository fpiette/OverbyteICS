...
Description:  TIcsFileCopy is a high level HTTP Delphi component that allows
              indexing and copying of multiple file directories, using a single
              function call.
Creation:     May 2001
Updated:      Mar 2019
Version:      8.60
...
type
  ...
  private
    { Private declarations }
        ...
        fMaxAttempts: integer ;     // March 2019
        fAttemptDelay: integer ;    // March 2019
  ...
  published
    ...
    property MaxAttempts: integer       read fMaxAttempts    write fMaxAttempts ;   // March 2019
    property AttemptDelay: integer      read fAttemptDelay   write fAttemptDelay ;  // March 2019
...
// main loop
    ...
    // break down URL, see if rebuilding without logon
     ...
     // March 2019 a few attempts, will use round robin DNS if more than one
...
// build list of target files, so we don't copy unnecessary stuff
    ...
    if NOT ForceDirectories (fDownDir) then
    begin
        result := TaskResFail ;
